                        ...
                        <Animated.View entering={FadeInDown.duration(700).delay(100).springify().damping(12)} className='flex-row justify-around'>
                            <View className='flex rounded-full bg-amber-300 p-2'>
                                ...
                                <View className='flex items-center py-2 space-y-1'>
                                    ...
                                    <Text style={{ fontSize: hp(1.3) }} className='font-bold text-neutral-700'>mints</Text>
                                        ...
                                        return (
                                            <View key={i} className='flex-row space-x-4'>
                                                ...
                                                <View className='flex-row space-x-2'>
                                                    <Text style={{ fontSize: hp(1.7) }} className='text-neutral-700 font-extrabold '>{meal['strMeasure' + i]}</Text>
                                                    <Text style={{ fontSize: hp(1.7) }} className='text-neutral-600 font-medium'>{meal['strIngredient' + i]}</Text>
                                                </View>
                                            </View>
                                        )
                                    })
